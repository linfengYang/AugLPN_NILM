...
offset = params_appliance[args.appliance_name]['windowlength']//2
print('offset:',offset)
...
model = AlexNet_model(args.appliance_name,
                  inp,
...
train_op = tf.train.AdamOptimizer(learning_rate=0.001,  # 0.001更改
                                  beta1=0.9,
                                  beta2=0.999,
                                  epsilon=1e-08,
...
if not args.transfer_model and args.transfer_cnn:
    save_path = args.save_dir + '/AlexNet_' + appliance_name + '_transf_' + args.cnn + '_pointnet_model'
else:
    save_path = args.save_dir + '/AlexNet_' + appliance_name + '_pointnet_model'
