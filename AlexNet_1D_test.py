...
if args.transfer:
    ...
    param_file = args.trained_model_dir + '/AlexNet_' + appliance_name + '_transf_' + args.cnn + '_pointnet_model'
else:
    print('arg.transfer'.format(args.transfer))
    param_file = args.trained_model_dir + '/AlexNet_' + args.appliance_name + '_pointnet_model'
