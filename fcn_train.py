...
if not args.transfer_model and args.transfer_cnn:
    save_path = args.save_dir+'/fcn_' + appliance_name + '_transf_' + args.cnn + '_pointnet_model'
else:
    save_path = args.save_dir+'/fcn_' + appliance_name + '_pointnet_model'
...
infos.to_csv('./FCN_training_infos-{:}.csv'.format(appliance_name))
